    ...
    switch ($options[xPDOTransport::PACKAGE_ACTION]) {
        ...
        case xPDOTransport::ACTION_UPGRADE:
            ...
            if ($oldPackage && $oldPackage->compareVersion('1.6.0', '>')) {
                $cleanup = [
                    'core' => [
                        'components/pdfresource/model/modpdf/modpdf.class.php',
                        'components/pdfresource/model/pdfresource/events'
                    ]
                ];
                cleanupFolders($modx, $corePath, $assetsPath, $cleanup, 'PDFResource', '1.6.0');
            }
            $success = true;
            break;
