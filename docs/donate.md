...
*PDFResource* is and always will be free and open-source, but it still requires
many man-hours of development, bug-fixing, support in MODX forums and on GitHub
between the releases.

Please support the ongoing and past development of *PDFResource* by making a
donation below.
...
*PDFResource* development is sponsored by Treehill Studio – MODX Development in Münsterland.
