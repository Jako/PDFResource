...
$_lang['setting_pdfresource.customFontsFolder_desc'] = 'Pfad zum Ordner mit den benutzerdefinierten Schriftarten. Wenn der Pfad nicht festgelegt oder verfügbar ist, wird "pdfresource.customFonts" nicht verwendet. Die Platzhalter {core_path}, {base_path} und {assets_path} können für diese Einstellung verwendet werden.';
